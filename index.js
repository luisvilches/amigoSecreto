...
const { createFile,append, createFileSms,createFileMail,appendSms,appendMail} = require("./functions/log");
...
function frindsSecrets(i,arr){
    if(i < arr){
        setTimeout(function(){
            ...
            sms(sorteo[i].num,sorteo[i].src,sorteo[i].dst,sorteo[i].mail);
            frindsSecrets(i,arr);
        }, 1000);
    }
};

function sms(p,n,f,m){
...
function enviarCorreo(arr,src,sdt){
    for(var i = 0; i < arr.length; i++){
        email(arr[i],src,sdt);//sdt
    };
}



function email(correo,src,sdt){

     var template2 = `<!--DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd" -->
         ...
         valign="top">
             ...
             bgcolor="#fff">
                 ...
                 align="center" bgcolor="#FF9F00" valign="top">
                     <img src="http://www.riabox.com.br/wp-content/uploads/2015/01/1024x1024-2.png" />
                 </td>
                 </tr>
                 <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding:20px;">
                    <div style="padding:20px;">
                        <h2>Amigo secreto Familiar 2017!!</h2>
                        <h4>Estimado(a) ${src} su amigo secreto es: ${sdt}.<h/4>
                        <br/>
                        <br/>
                        <p style="font-size:10px; margin-bottom:-10px">Frase Familiar:</p>
                        <p>No importa lo pobre que sea un hombre.</p>
                        <p>Si tiene familia, es rico.-Dan Wilcox.</p>
                    </div>
                 </tr>
             </table>
             <div class="footer" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; clear: both; color: #999; margin: 0; padding: 20px;">
                 ...
                 <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                     ...
                     valign="top">
                     Copyright 2017 - <a href="" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: underline; margin: 0;">Amigo Secreto Familiar 2017</a>. Todos los derechos reservados.</td>
                 </tr>
                 </table>
             </div>
             </div>
...
`
     ...
     if (error){
         ...
         appendMail(`correo enviado -> ${src} (${correo})`);
     }})
 }